...
```bash
canarynet --version
canarynet scan demos/                          # run against bundled demo
canarynet scan demos/ --format sarif --out r.sarif --fail-on high
canarynet mcp                                   # start as MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
- `demos/01-aws-key-honeytoken-tripped/` — see [`SCENARIO.md`](demos/01-aws-key-honeytoken-tripped/SCENARIO.md)
- `demos/02-document-canary-tripped/` — see [`SCENARIO.md`](demos/02-document-canary-tripped/SCENARIO.md)
- `demos/03-mixed-status/` — see [`SCENARIO.md`](demos/03-mixed-status/SCENARIO.md)
