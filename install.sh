#!/usr/bin/env sh
# Universal installer for canarynet. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/canarynet.git"
echo "Installing canarynet ..."
