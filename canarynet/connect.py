"""Native cognis-connect emit for canarynet — forward findings to any platform.

Maps canarynet's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    canarynet ... --format json | canarynet-emit --to stix
    canarynet-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
